export const ProjectSkeleton = () => {
  return (
    <section className="min-h-screen w-full px-4 py-20 md:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8 rounded-xl bg-linear-to-br from-gray-100 to-gray-200 p-8 dark:from-gray-800 dark:to-gray-900">
          ...
          <div className="mb-4 space-y-3">
            <div className="h-10 w-3/4 animate-pulse rounded bg-gray-300 dark:bg-gray-700" />
            <div className="h-10 w-1/2 animate-pulse rounded bg-gray-300 dark:bg-gray-700" />
          </div>

          {/* Button Skeleton */}
          <div className="h-12 w-40 animate-pulse rounded-xl bg-gray-300 dark:bg-gray-700" />
        </div>
