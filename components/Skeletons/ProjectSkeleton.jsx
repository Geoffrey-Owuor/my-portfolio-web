    ...
    <section className="w-full px-4 py-20 md:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-3 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="h-9 w-3/4 max-w-sm animate-pulse rounded-lg bg-border-subtle" />
          <div className="h-10 w-36 shrink-0 animate-pulse rounded-full bg-border-subtle" />
        </div>

        {/* Thin divider */}
        <div className="mb-10 h-px w-full bg-border-subtle" />

        {/* Project Image Skeleton (Full-width, borderless) */}
        <div className="mb-12 w-full">
          <div className="bg-border-subtle h-64 w-full animate-pulse rounded-2xl sm:h-80 md:h-[400px]" />
        </div>

        {/* About section Skeleton (No card, typography matching) */}
        <div className="mb-10">
          {/* "About" label */}
          <div className="mb-2 h-3 w-12 animate-pulse rounded bg-border-subtle" />
          {/* "Overview" title */}
          <div className="mb-5 h-7 w-32 animate-pulse rounded-lg bg-border-subtle" />
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="h-10 w-24 animate-pulse rounded-xl bg-border-subtle"
              />
            ))}
          </div>
        </div>
