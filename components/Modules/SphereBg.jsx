...
export default function SphereBg() {
  return (
    <div
      aria-hidden="true"
      className="sphereGroup absolute inline-flex h-70 w-70 items-center justify-center md:h-95 md:w-95"
    >
      <div
        className="absolute h-full w-full rounded-full border-[1.3px] border-dashed border-gray-300 dark:border-gray-600"
        style={{ animation: "spin-cw 10s linear infinite" }}
      />
