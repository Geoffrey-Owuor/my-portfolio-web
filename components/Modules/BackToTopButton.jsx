    ...
    <AnimatePresence>
      {showButton && (
        <motion.button
          ...
          className="fixed right-8 bottom-8 z-50 flex cursor-pointer items-center gap-2 rounded-full bg-gray-900 p-3 text-white shadow-lg transition-shadow hover:shadow-xl sm:rounded-xl dark:bg-white dark:text-gray-900"
        >
