    ...
    <AnimatePresence>
      {showButton && (
        <motion.button
          ...
          className="fixed right-8 bottom-20 z-50 flex cursor-pointer items-center gap-2 rounded-full bg-gray-900 px-3 py-3 text-white shadow-lg transition-shadow hover:shadow-xl sm:px-4 dark:bg-white dark:text-gray-900"
        >
